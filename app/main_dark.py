...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("app_images/logo.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        self.label_3.setPixmap(QtGui.QPixmap("app_images/logo.png"))
...
"}")
        ...
        self.label_5.setPixmap(QtGui.QPixmap("app_images/rectangle.png"))
